...
# ╔═╡ 48ee5936-aa89-4ddb-ae6e-722c20814aca
...
md"\"...where $\sigma$ (sigma) represents the ratio of fluid viscosity to thermal conductivity, $\rho$ (rho) represents the difference in temperature between the top and bottom of the system and $\beta$ (beta) is the ratio of box width to box height.\" -- Harris (2014, 2020)"
...
md"#### p: Parameters sigma, rho and beta"
