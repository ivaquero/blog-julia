...
# ╔═╡ 9bcd7ba8-3a7d-49ec-a65c-365ec62b7aef
begin
	using Pkg
	Pkg.activate()
	Pkg.instantiate()
...
md"a: $(@bind ua Slider(-5.:1.0:5.0, 1.0, true))"

# ╔═╡ 279df7fc-219a-461a-b359-c5b2cc9e7676
md"b: $(@bind ub Slider(ua+1.0:1.0:10.0, 1.0, true))"
